...
public class FileUtils {
    public static void generateFiles() throws IOException {
        File file1 = new File("lab1-multithreading/src/main/resources/file1.txt");
        forceCreate(file1);
        writeText(file1, """
        ...
        File file2 = new File("lab1-multithreading/src/main/resources/file2.txt");
        forceCreate(file2);
        writeText(file2, """
        ...
        File subdirFile1 = new File("lab1-multithreading/src/main/resources/subdir/file1.txt");
        ...
        System.out.printf("%nAll files were rewritten in P:\\kpi\\semester-5\\jwdc\\java-web-dev-course\\lab1-multithreading\\src\\main\\resources%n");
    }
