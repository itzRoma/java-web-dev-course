...
<t:page title="CoursePlatform | Update theme">
            ...
            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                    ...
                    <form class="d-flex flex-column"
                          action="${pageContext.request.contextPath}/admin-dashboard/themes/${requestScope.theme.name}/update"
                          method="post">

                        <input type="hidden" name="oldName" value="${requestScope.theme.name}">

                        <div class="input-group has-validation mb-3">
                            <div class="form-floating <c:if test="${requestScope.nameError != null}">is-invalid</c:if>">
                                <input type="text" name="name" value="${requestScope.theme.name}"
