...
public class PostCourseUnitCreateCommand extends Command {
    public PostCourseUnitCreateCommand(HttpServletRequest request, HttpServletResponse response) {
    ...
    public View execute() {
        ...
        try {
            ...
            service.create(new Unit(unitTitle, courseId));
