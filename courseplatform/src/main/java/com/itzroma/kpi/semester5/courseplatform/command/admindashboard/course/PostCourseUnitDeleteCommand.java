...
public class PostCourseUnitDeleteCommand extends Command {
    public PostCourseUnitDeleteCommand(HttpServletRequest request, HttpServletResponse response) {
    ...
    public View execute() {
        ...
        try {
            ...
            unitService.delete(unitService.findById(unitId));
